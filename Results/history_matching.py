...
inputFile_RealWater = open("../Input/gas.txt", "r")
...
for i in range(10): 
    ...
    print(str(i)+" - R² Error Water: ", r2_score(real_oil2, oil2))
    print("")
    ...
    output.write("R² Error Water: "+str(r2_score(real_oil2, oil2))+"\n")

    output.close()

    values = [[real_water2, water2],[real_oil2, oil2]]
